...
export default function Home({ href, title, description }: { href?: string, title?: string, description?: string }) {
  return (
    <>
    <div className="flex flex-col bg-gray-50 dark:bg-zinc-900 sm:max-w-[400px] w-full h-[150px] rounded-xl border-1 border-gray-300 sm:mx-4 mx-2 my-4 p-4 justify-center gap-2 shadow-md">
