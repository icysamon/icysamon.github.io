// src/app/components/ArticleLayout.tsx
import Link from "next/link";
import ReactMarkdown from "react-markdown";
import Background from "@/app/components/background";

// 記事の共通レイアウトコンポーネント（他の記事ページでも使い回せます）
export default function ArticleLayout({ content }: { content: string }) {
  return (
    <main className="font-sans antialiased min-h-screen relative overflow-x-hidden bg-white dark:bg-slate-900 flex justify-center pt-24 pb-12 px-4">
      {/* 幻想的なマカロンカラーの背景 */}
      <Background />
